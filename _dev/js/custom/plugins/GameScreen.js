...
function( DE )
{
   ...
   */
    ...
    GameScreen.prototype._cursorSelect = function()
    {
      ...
      this.currentButton.onMouseUp( { x: 0, y: 0 }, {} );
    };
  ...
  {
    DE.trigger( "gamescreen-show", this.name, args );
    this.trigger( "show", this, args );
    this.scene.enable = true;
    this.camera.enable = true;
    this.enable = true;
    this.trigger( "shown", this, args );
    DE.trigger( "gamescreen-shown", this.name, args );
  };
   ...
   * @memberOf GameScreen
   */
  GameScreen.prototype.hide = function( keepSceneActive, transition )
  {
    DE.trigger( "gamescreen-hide", this.name );
    ...
    DE.trigger( "gamescreen-hidden", this.name );
  };
